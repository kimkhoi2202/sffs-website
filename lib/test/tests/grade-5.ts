...
export const GRADE_5_TEST: Test = {
  ...
  items: [
    ...
    },
    {
      ...
      layout: "matrix",
      cells: [
        { shapes: [{ shape: "triangle", size: 0.44 }, { shape: "teardrop", size: 0.44 }] },
        {
          shapes: [
        ...
        },
        {
          shapes: [
            ...
            { shape: "teardrop", filled: true, color: "var(--color-gray-300)", rotate: 180, size: 0.24 },
          ],
        },
        {
          shapes: [
        ...
        },
        {
          shapes: [
            ...
            { shape: "teardrop", filled: true, rotate: 90, size: 0.34 },
          ],
        },
      ],
      options: [
        {
          id: "A",
          fig: { shapes: [{ shape: "triangle", size: 0.44 }, { shape: "teardrop", size: 0.44 }] },
          why: "WP-copy: the figure the grid starts from, with the rule not applied at all.",
        },
        {
          id: "B",
