  ...
  items: [
    ...
    },
    {
      ...
      cells: [
        ...
        {
          shapes: [
            { shape: "arrow", filled: true, color: "var(--color-gray-300)", size: 0.57 },
          ],
        },
        { shapes: [{ shape: "arrow", filled: true, size: 0.34 }] },
        { shapes: [{ shape: "arrow", rotate: 90, size: 0.8 }] },
        {
          shapes: [
            { shape: "arrow", filled: true, color: "var(--color-gray-300)", rotate: 90, size: 0.57 },
          ],
        },
        { shapes: [{ shape: "arrow", filled: true, rotate: 90, size: 0.34 }] },
        { shapes: [{ shape: "arrow", rotate: 180, size: 0.8 }] },
        {
          shapes: [
            { shape: "arrow", filled: true, color: "var(--color-gray-300)", rotate: 180, size: 0.57 },
          ],
        },
      ],
      options: [
        ...
        {
          id: "B",
          fig: { shapes: [{ shape: "arrow", filled: true, rotate: 270, size: 0.34 }] },
          why: "IC-flip: everything else right, and the turn carried one step too far.",
        },
        { id: "C", fig: { shapes: [{ shape: "arrow", filled: true, rotate: 180, size: 0.34 }] } },
        {
          id: "D",
          fig: {
            shapes: [
    ...
    },
    {
      ...
      explanation: "Across a row, the figure turns a step further round. Down a column, the shading goes from white to grey to solid and the figure gets smaller. The missing cell is whatever both of those give at once.",
      answer: "D",
    },
    {
      id: "grade-6-10",
    ...
    },
    {
      ...
      options: [
        ...
        { id: "B", fig: { shapes: [{ shape: "heart", filled: true, rotate: 90, size: 0.68 }] } },
        {
          id: "C",
    ...
    },
    {
      ...
      explanation: "Across a row, the figure gets smaller and the figure turns a step further round. Down a column, the shading goes from white to grey to solid. The missing cell is whatever both of those give at once.",
      answer: "A",
    },
  ],
};
